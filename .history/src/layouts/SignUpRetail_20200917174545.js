    ...
    if (not_social) {
      ...
      return (
        ...
        <BasicLayout title="Fazer Login">
          ...
          <li style={{marginLeft:"50px", marginRight:"50px"}} onClick={() => { this.handleNoSocial() }} style={{
            // display: "flex",
            ...
            <div style={{marginLeft:"50px", marginRight:"50px"}}className={useStyles.button}><div className={useStyles.btIcon}><BiLogIn/></div>Prefiro me cadastrar</div>
          </li>
