    ...
    <div>
      <div className="price_block border_top">
        ...
        <div className="price_head ">
          ...
          <h2>{props.plan}</h2>
          {props.price ? (<><h4>{`R$ ${props.price}`}</h4>
          <span className="montly" >mensal</span></>) : (<h4>GRATIS</h4>)}
          ...
          <div className="container">
            <>
              <div className="price_container wrap">
                <PriceContainer plan="Plano Bronze"  recommend={true} features={<PriceFeatures/>} url="rsignup/bronze"/>
                <PriceContainer plan="Plano Prata"  recommend={true} features={<PriceFeatures/>} url="rsignup/silver"/>
                <PriceContainer plan="Plano Ouro"  recommend={true} features={<PriceFeatures/>} url="rsignup/gold"/>
                <PriceContainer plan="Plano Diamante"  recommend={true} features={<PriceFeatures/>} url="rsignup/diamond"/>
                <div className="price_block border_top">
                  ...
                  <PriceFeatures />
                  <div className="price_button_wrapper">
                    <a href="rsignup/silver" className="price_button pb_green">Assine Já</a>
                  </div>
                ...
                <div className="price_block border_top">
                  ...
                  <div className="price_head  border_top">
                  ...
                  <PriceFeatures />
                  <div className="price_button_wrapper">
                    <a href="rsignup/gold" className="price_button pb_green">Assine Já</a>
                  </div>
                </div>
                <div className="price_block border_top last ">
                  <div className="recommend "></div>
                  ...
                  <PriceFeatures />
                  <div className="price_button_wrapper">
                    <a href="rsignup/diamond" className="price_button pb_green">Assine Já</a>
                  </div>
                </div>
              </div>
            </>
