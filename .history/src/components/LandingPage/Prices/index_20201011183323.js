            ...
            >
              <>
                <div className="row  flex ">
                  <div className="threecol left_fade animated fadeInLeft">
                    <div className="price_head green_head">
                      <h2>Plano Bronze</h2>
                      <h4 className="price_head ">GRATIS</h4>
                  ...
                  <div className="threecol up_fade animated fadeInUp">
                  ...
                  <div className="threecol  right_fade animated fadeInRight">
                  ...
                  <div className="threecol last  right_fade animated fadeInRight">
