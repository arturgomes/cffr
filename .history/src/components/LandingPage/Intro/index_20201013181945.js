            ...
            <div className="row">
              <div className="col-lg-8">
                <div className="text-container">
                  ...
                  o varejista na coleta de feedbacks das experiências de seu cliente. E juntos vamos além: estabelecemos um canal direto de comunicação com os seus clientes lhe permitindo <span>fechar o loop</span> após seus feedbacks. E em troca, o
