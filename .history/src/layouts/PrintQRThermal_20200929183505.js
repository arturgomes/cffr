...
export default class PrintQRThermal extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await fetch("https://api.couponfeed.com.br/shopsl",
      {
        method: "POST",
        credentials: "include",
        body: { shop_id: qs },
    ...
    const res = await api.post(`https://api.couponfeed.com.br/files/${this.state.retail_id}`);
    // const res = await await fetch(`https://api.couponfeed.com.br/files/${this.state.retail_id}`, 
    // {
    //   method: "POST",
    //   credentials: "include",
    //   // body: { shop_id: qs },
    ...
    if (this.state.isLoading) {
      ...
      return (
        <div className="mainTH" >
          ...
          {/* <div className="steps"> */}
            Não conseguiu acessar o QR code? Acesse <spam>https://couponfeed.com.br/f/{this.state.short_url}</spam>
          <div className="logo-container">
            <p><img src={cflogo} alt="" style={{ width: '350px' }} /></p>
            <p><FaHome /> https://couponfeed.com.br</p>
