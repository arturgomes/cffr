              ...
              <div className="price_container wrap">
                <div className="fourcol">
                  ...
                  <div className="services_box">
                    ...
                    <details>
                    <p><summary>Na CouponFeed, você não precisa se preocupar com a aquisição e manutenção de tablets ou totens. </summary>Através de um <span>QR code</span>, o cliente dará o feedback diretamente de seu smartphone.</p>
                    </details>
                  </div>
                  {/* end services_box */}
