          ...
          <div className="section_wrapper white_bg">
            ...
            <div className="desc_container">
                ...
                {/* <div className="twelvecol"> */}
                  {/* begin fourcol */}
                  <div className="desc_block services_item align_center left_fade">
                    {/* begin zoom_photo */}
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="desc_block services_item align_center up_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="desc_block services_item last align_center right_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
