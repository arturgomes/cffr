          ...
          <div className="col">
            ...
            <ul className="list-unstyled li-space-lg">
              ...
              <li><FaWhatsapp className="turquoise" style={{ fontSize: 20, marginRight:'10px' }} />
                <Link className="turquoise"
                  href="https://wa.me/5567993021141">+55 67 99302-1141</Link >
              </li>
              <li><i className="fas fa-envelope" style={{ fontSize: 20, marginRight:'10px'}} ></i><Link className="turquoise"
                href="mailto:couponfeedbr@gmail.com">couponfeedbr@gmail.com</Link ></li>
            </ul>
          </div>
          <div className="col">
            ...
            <p >Copyright © 2020 <a href="https://couponfeed.com.br" >CouponFeed</a > - Todos os direitos reservados</p>
