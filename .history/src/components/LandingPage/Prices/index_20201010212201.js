        ...
        <div id="pricing" className="cards-2">
          <div className="container">
            ...
            >
              <>
                <div class="row">
                  <div class="threecol price_item left_fade animated fadeInLeft">
                    <div class="price_head green_head">
                      <h2>Basic Pack</h2>
                      <h4>$ 19,<small>99</small>
                      </h4>
                    ...
                    <ul class="price_features">
                      <li class="first">
                        ...
                        <span class="right">
                          <i class="icon icon-check-mark green">
                          </i>
                        </span>
                      </li>
                      <li>
                  ...
                  <div class="threecol price_item up_fade animated fadeInUp">
                  ...
                  <div class="threecol price_item right_fade animated fadeInRight">
                  ...
                  <div class="threecol last price_item right_fade animated fadeInRight">
                ...
                <div className="card" key={p}>
                  <div className="card-body">
                    ...
                    <div className="price">
                      ...
                      <span className="value">{p.prices.monthly}</span>
                      <div className="frequency">mensal</div>
                    </div>
                    <hr className="cell-divide-hr" />
                    <div className="price">
                      <span className="currency">R$ </span>
                      <span className="value">{(p.prices.trimestral / 3).toFixed(2)}</span>
                    ...
                    <div className="price">
                      <span className="currency">R$ </span>
                      <span className="value">{(p.prices.anual / 12).toFixed(2)}</span>
