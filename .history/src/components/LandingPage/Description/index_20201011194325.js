        ...
        {/* <div id="services"> */}
          ...
          <div className="section_wrapper white_bg">
            ...
            <div className="section_box">
              {/* begin row */}
              <div className="desc_container wrap">
                {/* begin twelvecol */}
                {/* <div className="twelvecol"> */}
                  {/* begin fourcol */}
                  <div className="desc_block align_center left_fade">
                    {/* begin zoom_photo */}
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="desc_block  align_center up_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="desc_block  last align_center right_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
