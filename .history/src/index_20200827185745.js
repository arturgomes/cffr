...
import "./views/LandingPage/assets/css/bootstrap.min.css";
import "./views/LandingPage/assets/scss/paper-kit.scss?v=1.2.0";
import "./views/LandingPage/assets/demo/demo.css?v=1.2.0";
// import "./index.css";
// import App from "./App";
