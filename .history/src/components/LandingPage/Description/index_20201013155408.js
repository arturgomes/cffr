        ...
        <div className="content_container">
          <div className="threecol">
            ...
            <div className="services_box">
              ...
              <p>Na CouponFeed, você não precisa se preocupar com a aquisição e manutenção de tablets ou totens. Através de um <span>QR code</span>, o cliente dará o feedback diretamente de seu smartphone.</p>
