...
const Google = () => (
  <Block>
      <span className="turquoise">Google</span>
...
const Amazon = () => (
  <Block>
    {/* <Card> */}
      ...
      <Text>PageRank is the search algorithm that started it all. Today it's a multibillion dollar company.</Text>
      {/* <h1>Amazon</h1>
    <Text>This is Amazon. It started off as an online bookstore.</Text>
    <Text>Amazon is the owner of AWS, the host this tutorial is targeting.</Text> */}
    {/* </Card> */}
  </Block>
)
...
const FaceBook = () => (
  <Block>
    <h1>FaceBook</h1>
    <Text>This is FaceBook. It was started by Mark Zuckerberg at Harvard.</Text>
    <Text>FaceBook is the creator of the framework used to build this website, React.</Text>
  </Block>
)
...
const Apple = () => (
  <Block>
    <h1>Apple</h1>
    <Text>This is Apple. It's CEO is Tim Cook.</Text>
    <Text>Apple manufactures the iPhone and the Mac.</Text>
  </Block>
)
