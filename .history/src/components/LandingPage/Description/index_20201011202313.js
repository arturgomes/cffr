            ...
            <div className="section_box">
              ...
              <div className="row">
                ...
                {/* <div className="twelvecol"> */}
                  {/* begin fourcol */}
                   <div className="threecol services_item align_center left_fade">
                    {/* begin zoom_photo */}
                  ...
                  <div className="threecol services_item align_center up_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
                  ...
                  <div className="threecol services_item last align_center right_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
