    ...
    return (
      <>
        {/* <div id="services"> */}
          ...
          <div className="section_wrapper white_bg">
            {/* begin section_box */}
            <div className="section_box">
              ...
              <div className="price_container">
                ...
                {/* <div className="twelvecol"> */}
                  {/* begin fourcol */}
                  <div className="price_block services_item align_center left_fade">
                    {/* begin zoom_photo */}
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="price_block services_item align_center up_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
                  ...
                  {/* end fourcol */}
                  {/* begin fourcol */}
                  <div className="price_block services_item last align_center right_fade">
                    {/* begin zoom_photo */}
                    <div className="zoom_photo">
                      <div className="view view-first">
