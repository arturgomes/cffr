...
import ButtonAct from "../components/Button/ButtonAct";
...
export default class SignUp extends Component {
  ...
  render() {
    ...
    if (not_social) {
      ...
      return (
        <BasicLayout title="Fazer Cadastro com Rede Social">
          {/* <Avatar className={useStyles.avatar}>
            <LockOutlinedIcon />
          </Avatar> */}
          ...
          >
            {/* <LoginSocial /> */}
            <LoginSocial retail={true} title="Cadastrar usando login do" />
            <ButtonAct
              caption="Prefiro me cadastrar"
              click={() => {
                this.handleNoSocial();
              }}
              icon={<BiLogIn />}
