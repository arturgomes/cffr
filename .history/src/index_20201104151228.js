...
import FeedbackBlock from "./layouts/FeedbackBlock.js";
...
// import Model from "./layouts/LandingPage/Model.js";
import LandingPage from "./layouts/LandingPage/LandingPage.js";
import Pricing from "./layouts/LandingPage/Pricing.js";
...
ReactDOM.render(
  <BrowserRouter>
    <Switch>
      ...
      <Route path="/blog" exact render={() => (window.location = "http://blog.couponfeed.com.br")} />
      {/* <Route path="/test" exact component={Model} /> */}
      ...
      <Route path="/feed/:id" component={FeedbackBlock} />
