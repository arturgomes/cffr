  ...
  return (
    <div>
      <div className="price_block border_top">
        {props.recommend===true ? (<div className="recommend "></div>) : (<div className="recommend bg_green">Recomendado</div>)}
        ...
        <div className="price_button_wrapper">
          <a href="/rsignup/bronze" className="price_button pb_green">Assine Já</a>
        </div>
      </div>
          ...
          <div className="container">
            <>
              <div className="price_container wrap">
                <PriceContainer plan="Plano Bronze" recommend={true} features={<PriceFeatures/>}/>
                <div className="price_block border_top">
