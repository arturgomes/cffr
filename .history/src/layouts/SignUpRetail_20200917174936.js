      ...
      return (
        ...
        <BasicLayout title="Fazer Login">
          ...
          <li onClick={() => { this.handleNoSocial() }} style={{
            ...
            <div style={{ marginLeft: "50px", marginRight: "50px" }} className={useStyles.button}>
              <div className={useStyles.btIcon}>
                <BiLogIn />
              </div>
                Prefiro me cadastrar
                </div>
          </li>
          <div className={classes.nosocial} onClick={() => { this.handleNoSocial() }} >
              <BiLogIn/>
              Prefiro me cadastrar</div>
          </div>
