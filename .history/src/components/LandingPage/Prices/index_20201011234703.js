...
function PriceContainer(props) {
  return (
    <div>
      <div className={`price_block border_top ${props.recommend ===true ? 'price_grey' : ''}`}>
          ...
          <div className="container">
            <>
              <div className="price_container wrap">
                ...
                <PriceContainer plan="Plano Prata"  recommend={true} features={<PriceFeatures  nfeedbacks={200} nqr={1} />} url="rsignup/silver"/>
                <PriceContainer plan="Plano Ouro"  features={<PriceFeatures nfeedbacks={1000} nqr={3} />} url="rsignup/gold"/>
                <PriceContainer plan="Plano Diamante" features={<PriceFeatures/>} url="rsignup/diamond"/>
               </div>
            </>
          </div>
        </div>
