            ...
            <>
              <div className="price_container wrap">
                ...
                <PriceContainer
                  ...
                  recommend={true}
                  features={
                    <PriceFeatures nfeedbacks={200} nqr={1} dashboard={true} />
                  }
                  url="rsignup/silver"
                  purpose="Para lojas únicas ou franquias poderem aumentarem a retenção dos clientes"
                />
                <PriceContainer
                  plan="Plano Ouro"
                  price={249}
                  features={
                    <PriceFeatures nfeedbacks={1000} nqr={3} dashboard={true} />
                  }
                  url="rsignup/gold"
