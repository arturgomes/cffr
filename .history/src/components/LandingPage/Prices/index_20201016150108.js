            ...
            <>
              <div className="price_container wrap">
                ...
                <PriceContainer
                  ...
                  price={99}
                  recommend={true}
                  features={<PriceFeatures nfeedbacks={200} nqr={1} dashboard={true}/>}
                  url="rsignup/silver" 
                  purpose="Ideal para começar a introduzir a cultura de customer experience na empresa"
                  
                  />
                <PriceContainer
                  plan="Plano Ouro"
                  price={249}
                  features={<PriceFeatures nfeedbacks={1000} nqr={3} dashboard={true}/>}
                  url="rsignup/gold" 
                  purpose="Ideal para começar a introduzir a cultura de customer experience na empresa"
                ...
                <PriceContainer
                  plan="Plano Diamante"
                  price={399} features={<PriceFeatures dashboard={true} pers={true}/>}
                  url="rsignup/diamond" 
                  
                  purpose="Para Shoppings, Lojas de Departamento ou Supermercados que desejam avaliar diferentes aspectos do negócio."
